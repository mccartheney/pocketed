    ...
    if (economies.length === 0) return (
        <div className="w-2/6 h-full ml-3 bg-base-200 rounded-2xl p-3 flex flex-col">
            ...
            <div className="flex flex-col items-center justify-center h-full">
                ...
                <motion.p className="text-center text-sm text-base-content" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>Add an economy to this card, pls 🥺</motion.p>
            </div>
        </div>
    )
